...
content_zh: |
  张载的《西铭》是一篇仅三百余字的短文，却包含了中国哲学中最深刻的互联性思想。"乾称父，坤称母"——天地是万物的父母，所有存在都是同一个气的凝聚形态，所有人都是同一个家庭的成员。这不是诗意比喻，而是本体论声明：宇宙不是由孤立个体构成的集合，而是由一个连续的、动态的、相互渗透的基质构成的整体。

  气（qi）提供了互联的物理基础：你的身体、山脉、河流和星辰都是同一物质的局部凝聚。性（xing）则提供了互联的伦理维度：因为万物同源，所以对他人的关怀不是慈善而是天职，对万物的尊重不是选择而是本性。张载的四句教——"为天地立心，为生民立命，为往圣继绝学，为万世开太平"——正是这种互联意识的实践表达。

  在全球化危机与生态挑战的当代，张载的互联哲学不是古人的理想主义，而是我们亟需的认知框架：没有孤立的解决方案，没有局外的旁观者，万物一体，责任共担。
---
