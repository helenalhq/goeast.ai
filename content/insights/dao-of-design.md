...
content_zh: |
  当极简主义成为全球设计的主流美学，我们很少追问它的哲学根源。老子的道家思想——道、无为与朴——恰恰为现代极简设计提供了最深厚的理论基础。朴不是刻意追求简单，而是回归事物未经雕琢的本性；无为不是不做设计，而是让设计隐入使用之中；道不是风格指南，而是事物自然运作的深层规律。
...
Want to explore Laozi's design philosophy further? Consult the Oracle at GoEast.ai.
