...
content_zh: |
  了解中国文化对于在中国的成功旅行和生活至关重要。本指南涵盖了每个访客都应该知道的基本概念。
  ...
  **表示尊重：**
  ...
  ### 1. 直接批评
  **问题：** 西方直接沟通风格可能被视为粗鲁
  **解决：** 学习间接表达，使用"可能"、"也许"等词

  ### 2. 给小费
  **问题：** 中国没有小费文化
  **解决：** 不要给小费，可能被拒绝或被视为侮辱
  ...
  **解决：** 展示对集体和家庭的重视
  ...
  ### 什么是中国最重要的文化概念？
  面子、关系和和谐是最重要的三个概念。理解这些将帮助你导航大多数社交情况。

  ### 如何在中国表示尊重？
  尊重长辈，注意等级，学习基本礼仪，展示对中国文化的真诚兴趣。

  ### 我应该避免什么话题？
  避免政治敏感话题、领土问题，以及过于私人的问题。专注于文化、历史、食物和安全话题。

  ### 和中國同事意见不同可以吗？
  可以，但要间接表达。使用"也许我们可以考虑..."而不是"你错了"。
  ...
  通过理解和尊重这些概念，你将在中国建立更深层的关系，获得更丰富的体验。

  ## 相关阅读
  - [仁的含义](/glossary/ren)
  - [礼的含义](/glossary/li)
  - [中庸的含义](/glossary/zhongyong)
  - [孔子生平与思想](/sophies-journey/ch02-confucius)
  - [中国哲学洞见](/insights)
---
...
### 1. Direct Criticism
**Problem:** Western direct communication style may be seen as rude
**Solution:** Learn indirect expression, use "maybe," "perhaps"

### 2. Tipping
**Problem:** Tipping isn't part of Chinese culture
**Solution:** Don't tip; it may be refused or seen as insulting

### 3. Discussing Sensitive Topics
**Problem:** Political topics may make people uncomfortable
**Solution:** Focus on culture, food, travel, and safe topics

### 4. Ignoring Hierarchy
**Problem:** Egalitarian attitudes may be seen as disrespectful
**Solution:** Be mindful of age, position, and context

### 5. Excessive Individualism
**Problem:** Emphasizing the individual may be seen as selfish
**Solution:** Show respect for collective and family
...
- [The Meaning of Ren (仁)](/glossary/ren)
- [The Meaning of Li (礼)](/glossary/li)
- [The Meaning of Zhongyong (中庸)](/glossary/zhongyong)
- [Confucius: Life and Teachings](/sophies-journey/ch02-confucius)
- [Chinese Philosophy Insights](/insights)
