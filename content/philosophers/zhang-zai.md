---
slug: zhang-zai
journey_slug: ch08-zhangzai
biography_zh: |
  张载，字子厚，号横渠，北宋关中人，生于1020年，卒于1077年。他是理学开创期最重要的思想家之一，创立了"关学"——以气为本的哲学体系。张载少年时志于军事，曾欲组织民兵抵御西夏入侵，后受范仲淹劝导转习儒学。他曾长期在关中讲学，与程颢、程颐交流辩论，奠定了理学的基础。张载的哲学以"气"为核心：他提出"太虚即气"——虚空不是空无一物而是气的无形状态，万物由气的聚散而生灭。他最著名的贡献是"横渠四句"——"为天地立心，为生民立命，为往圣继绝学，为万世开太平"——这四句誓言成为中国知识分子的精神坐标，至今仍被广泛引用。他还著有《正蒙》《西铭》等，其中《西铭》以"民胞物与"的观念将万物视为一个大家庭，深刻影响了后世的伦理思想。
modern_influence: |
...
modern_influence_zh: |
  ...
  张载的四句誓言——"为天地立心，为生民立命，为往圣继绝学，为万世开太平"——仍是中国文化中最被引用的知识理想陈述。它们被刻在大学建筑上、在毕业典礼中被引用、被公共知识分子作为学术志向应当衡量的标准。四句将知识定义为公民责任而非个人成就——学问为宇宙秩序、民众福祉、文化传承与世代和平而存在。

  ## 张载与现代物理学

  张载"太虚即气"的理论——看似空无一物的空间实际上充满了不可见的、动态的基底，凝聚为可见物质、消散回归不可见——被比作现代量子场论。在量子物理中，真空不是空的而是涌动着虚粒子与波动场；物质通过凝聚（对称性破缺）从此基底中涌现。张载用十一世纪中国形而上学的词汇描述了同一想法。

  ## 张载与生态伦理

  张载"民胞物与"的概念将道德考量延伸至自然世界。这种关系生态学——山、河、植物与动物是同一个家庭的成员——预示了现代环境伦理与深层生态学哲学。它提供了一种不依赖个人权利而是依赖关系归属的非西方生态责任根基。
core_concepts:
...
quotes:
  ...
  - text: "Qi condenses to form things; qi disperses to return to the void. When qi condenses, I am born; when qi disperses, I die. Birth is not gaining something new; death is not losing something old. Birth and death are like the condensation and dispersion of qi."
    ...
    interpretation_zh: 张载将生死重构为气转化的阶段而非绝对的开端与终结。你出生时不是从无中被创造；你是已有之气的凝聚。你死亡时不归入虚无；你消散回终将再次凝聚的气中。这通过将死亡变成相变而非灭绝消除了毁灭的恐惧。
  - text: "When you know that the void is not empty, then Buddhist talk of emptiness is mere words; when you know that qi condenses and disperses, then Buddhist talk of birth and death as illusion is mistaken."
  ...
  - text: "When qi is clear, it forms heaven; when qi is turbid, it forms earth. The clear qi circulates above as sun, moon, and stars; the turbid qi gathers below as mountains, rivers, and soil. But they are all one qi, not two different substances."
    ...
    interpretation_zh: 张载通过气的清浊变化解释宇宙结构。天地、星辰与土壤不是不同种类的物质而是同一气的不同配置。这一一元唯物论消除了精神与物理领域之间的二元划分——一切是同一物质在不同凝聚与清浊状态中。
  - text: "To set the heart for heaven and earth is to participate in the creative process of the cosmos. To establish destiny for the people is to give them a stable ground for their existence. To continue the lost learning of past sages is to preserve what would otherwise perish. To open peace for ten thousand generations is to create conditions that future ages will inherit."
    text_zh: "为天地立心，参与天地之化育。为生民立命，使民有所立。为往圣继绝学，使前人之学不绝。为万世开太平，使后世承太平之基。"
    source: "Zhang Zai, expanded commentary on the Four Vows"
    source_zh: "《张载集》四句扩展注释"
    ...
    interpretation_zh: 张载对四句的自己扩展，使每一条款具体化。为天地立心意味着主动参与宇宙创生。为生民立命意味着创造人民得以繁盛的社会条件。继绝学意味着拯救知识遗产免于湮灭。开太平意味着建立跨代延续的制度与实践。
---
