---
slug: zhuangzi
journey_slug: ch04-zhuangzi
biography_zh: |
  庄子，名周，战国时期宋国蒙人，与孟子同时而年辈稍长。他曾为漆园吏——一个卑微的地方小官——但不久便辞去，过着贫困而自由的生活。楚王曾遣使以相位相邀，庄子以神龟宁愿生而曳尾于泥中、不愿死而藏于庙堂之比喻婉拒，表明对官场的彻底不屑。庄子继承并发展了老子的道家思想，所著《庄子》一书现存三十三篇，分为内篇七、外篇十五、杂篇十一，以汪洋恣肆的文风著称。他提出"逍遥"为最高自由，以梦蝶寓言质疑自我与现实的边界，以庖丁解牛说明技艺之极近乎天道，以无用之木揭示有用与无用的辩证。庄子是中国哲学中最具文学性与想象力的思想家，其影响遍及美学、文学、禅宗乃至现代生态哲学。
modern_influence: |
...
modern_influence_zh: |
  ...
  庄子的梦蝶寓言已成为现代意识哲学的参照点。"我是庄周梦为蝴蝶，还是蝴蝶梦为庄周？"这一问题预示了模拟假说、虚拟现实理论与意识的硬问题。丹尼尔·丹内特、托马斯·梅辛格等认知科学家引用庄子悖论作为他们所面对的同一问题的前现代版本：主观体验与客观现实之间的关系是什么？

  ## 庄子在艺术与文学中的影响

  庄子的文风——嬉戏、悖谬、狂放想象——对中国文学的影响超过任何其他哲学文本。其类比、寓言与不合逻辑的并置技巧成为中国文学美学的基石。从庄子经李白、苏轼到鲁迅等现代作家，"以荒诞揭示真实"的传统本质上是一条庄子的文学谱系。

  ## 庄子与后现代哲学

  庄子对概念范畴的不懈解构——拒绝接受任何关于对错、有用无用、自我与他者的固定区分——与后现代与解构思想共鸣。德里达对二元对立的批判与福柯对概念体制的分析都呼应了庄子的洞见：范畴是工具而非真理，对任何概念系统的僵化执着是智识暴政的一种形式。
core_concepts:
  ...
  - name: Skill as Dao (Jiyang)
    ...
    description_zh: 庄子庖丁解牛的故事——以毫不费力的精准切割牛体，刀刃十九年未磨——阐明了技艺在其最高处成为精神 mastery 的原则。当技艺如此彻底内化以至于匠人无需思考便行动时，技术与道之间的界限消融了。
quotes:
  - text: "Once I, Zhuang Zhou, dreamed that I was a butterfly, fluttering happily here and there. I was convinced that I was a butterfly, with no knowledge of Zhuang Zhou. Suddenly I woke up, and there I was, unmistakably Zhuang Zhou. But I do not know whether I was Zhuang Zhou dreaming I was a butterfly, or a butterfly dreaming I am now Zhuang Zhou."
    text_zh: "昔者庄周梦为胡蝶，栩栩然胡蝶也。自喻适志与！不知周也。俄然觉，则蘧蘧然周也。不知周之梦为胡蝶与，胡蝶之梦为周与？"
    source: "Zhuangzi, Chapter 2"
    source_zh: "《庄子·齐物论》"
    interpretation: The most famous passage in Chinese philosophy. Zhuangzi does not resolve the paradox — he leaves it open, forcing the reader to confront the inadequacy of any fixed identity. The point is not that reality is a dream but that certainty about who you are is always provisional.
    interpretation_zh: 中国哲学中最著名的段落。庄子不解决悖论——他让它保持开放，迫使读者面对任何固定身份的不充分性。要点不是现实是梦，而是关于你是谁的确定性总是暂时的。
  - text: "The fish trap exists because of the fish; once you have the fish, you can forget the trap. The rabbit snare exists because of the rabbit; once you have the rabbit, you can forget the snare. Words exist because of meaning; once you have the meaning, you can forget the words."
    text_zh: "筌者所以在鱼，得鱼而忘筌；蹄者所以在兔，得兔而忘蹄；言者所以在意，得意而忘言。"
    source: "Zhuangzi, Chapter 26"
    source_zh: "《庄子·外物》"
    ...
    interpretation_zh: 语言是工具而非事物本身。一旦你抓住意义，执着于言词便失去意义。庄子的全部文学方法——荒诞故事、矛盾、刻意的胡言——旨在打破读者对语言表述的执着，推向直接理解。
  - text: "A frog in a well cannot conceive of the ocean; a summer insect cannot conceive of ice. How can a person with a small mind discuss great things?"
    text_zh: "井蛙不可以语于海者，拘于虚也；夏虫不可以语于冰者，笃于时也；曲士不可以语于道者，束于教也。"
    source: "Zhuangzi, Chapter 17"
    source_zh: "《庄子·秋水》"
    interpretation: Every perspective is limited by its conditions — space, time, and conceptual training. Zhuangzi does not dismiss the small perspective but notes that it cannot comprehend the large. Wisdom is not the replacement of a small perspective with a large one but the recognition that all perspectives are partial.
    interpretation_zh: 每一视角都受其条件限制——空间、时间与概念训练。庄子不排斥小视角，而是指出它无法理解大视角。智慧不是以大视角取代小视角，而是认识到所有视角都是部分的。
  - text: "My life has a limit, but knowledge has no limit. To pursue what has no limit with what has a limit is dangerous."
    text_zh: "吾生也有涯，而知也无涯。以有涯随无涯，殆已。"
    ...
    interpretation_zh: 庄子警告追求全知的西西弗斯式努力。既然生命有限而知识无限，试图知一切便会耗竭求知者而不达目标。明智的做法是知你所需，放你所不需，专注于好好生活而非积累信息。
  - text: "When the shoe fits, the foot is forgotten; when the belt fits, the belly is forgotten. When the heart is right, right and wrong are forgotten."
    text_zh: "忘足，履之适也；忘要，带之适也；知忘是非，心之适也。"
    ...
    interpretation_zh: 任何实践的最高状态是它变得如此自然以至于你忘记你在实践。合脚的鞋从注意力中消失；运作良好的道德感从意识中消失。庄子的理想不是有意识的德行而是无自我意识的合宜——正确行动不经深思便流淌的状态。
  - text: "The perfect man has no self; the holy man has no achievement; the sage has no name."
    text_zh: "至人无己，神人无功，圣人无名。"
    source: "Zhuangzi, Chapter 1"
    source_zh: "《庄子·逍遥游》"
    interpretation: Zhuangzi's definition of human perfection is defined by absences, not additions. The perfect person is not someone who has accumulated virtues but someone who has shed attachments — to self, to achievement, to reputation. Freedom is subtraction, not accumulation.
    interpretation_zh: 庄子对人的完美的定义由缺失而非增添来界定。完美的人不是积累了德行的人，而是脱落了执着的人——对自我的执着、对成就的执着、对名声的执着。自由是减法而非加法。
  - text: "The usefulness of the useless."
    text_zh: "无用之用。"
    source: "Zhuangzi, multiple chapters"
    source_zh: "《庄子》多个篇章"
