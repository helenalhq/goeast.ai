...
biography_zh: |
  老子，姓李名耳，字聃，相传为春秋时期楚国苦县人。他曾任周朝守藏室之史，掌管国家典籍数十年，得以博览古今之变。晚年见周室衰微，遂西行出关。关令尹喜请其著书，老子乃留下五千言的《道德经》，然后不知所终。这部著作以"道"为核心概念，阐述了宇宙的本源、万物的运行法则与人类应当遵循的生活方式。老子主张无为而治、柔弱胜刚强、返朴归真，其思想深刻影响了道家哲学、中国艺术、中医理论乃至现代环保主义。他被道教尊为太上老君，在西方则被视为东方智慧的最重要代表之一。《道德经》是除《圣经》外被翻译最多的经典著作。
modern_influence: |
...
modern_influence_zh: |
  ...
  老子"无为"的思想——不强行而为——在现代管理理论中找到了意外的归属。敏捷方法论、精益创业原则以及"仆人式领导"模型，无不呼应着道家洞见：最好的领导者是创造成功条件的人，而非命令结果的人。当一位CEO说"让团队自己找到解决方案"时，她正在实践无为——只是不知道这个术语。

  ## 环境哲学与道家

  老子将人类视为自然的一部分而非其主宰的视野，比生态运动早了两千年。他强调顺应自然模式而非强加人为设计，与可持续发展思维深度共鸣。朴门永续设计——与自然生态系统而非对抗自然的设计哲学——本质上是道家思想的实践。当比尔·莫里森在1970年代提出这一概念时，他无意中重述了老子的原则：上善若水。

  ## 《道德经》作为全球智慧经典

  仅英文翻译就有250多种，《道德经》是历史上被翻译最多的中国文本，也是除《圣经》外全球翻译最多的书籍。它影响了物理学家（玻尔在纹章上放置了太极阴阳符号）、心理学家（荣格大量论述道家冥想）、艺术家（约翰·凯奇运用源自《易经》的偶然操作法）以及从垮掉一代到现代正念实践的各类反文化运动。
core_concepts:
  ...
  - name: Wu Wei (Non-Action)
    ...
    description_zh: 无为不是消极，而是顺应自然趋势而动的艺术——如善于读风的航海者而非与之搏斗者。最高的效能来自最少的努力，因为逆现实之势的努力制造阻力。水不会试图向下流；它只是流淌。
  - name: Softness Overcomes Hardness
    name_zh: 柔弱胜刚强
    description: Laozi observed that water, the softest substance, erodes rock, the hardest. Teeth are hard and decay early; gums are soft and last a lifetime. This is not romanticism but physics — flexibility adapts, rigidity breaks. In every system, the element that yields endures; the element that resists shatters.
...
quotes:
  - text: "The Tao that can be told is not the eternal Tao. The name that can be named is not the eternal name."
    text_zh: "道可道，非常道。名可名，非常名。"
    source: "Tao Te Ching, Chapter 1"
    source_zh: "《道德经》第一章"
    interpretation: The opening line of the Tao Te Ching declares the limits of language itself. Any attempt to describe the ultimate reality fails because description reduces the infinite to the finite. This is not nihilism but a call to direct experience beyond words.
    interpretation_zh: 《道德经》开篇宣告了语言本身的限度。任何描述终极现实的尝试都会失败，因为描述将无限缩减为有限。这不是虚无主义，而是召唤直接体验——超越文字的体验。
  - text: "The highest good is like water. Water gives life to the ten thousand things and does not strive. It flows in places men reject and so is like the Tao."
    text_zh: "上善若水。水善利万物而不争，处众人之所恶，故几于道。"
    source: "Tao Te Ching, Chapter 8"
    source_zh: "《道德经》第八章"
    interpretation: Water is Laozi's master metaphor. It nourishes without demanding recognition, occupies low places others avoid, and yet accomplishes the most essential work. Virtue, like water, works by flowing rather than asserting.
    interpretation_zh: 水是老子最核心的隐喻。水滋养而不求认可，居于他人所避的低处，却完成最必要的工作。德如水，以流淌而非声称而运作。
  ...
  - text: "He who stands on tiptoe is not steady. He who strides cannot maintain the pace. He who displays himself does not shine. He who justifies himself has no glory."
    ...
    source: "Tao Te Ching, Chapter 24"
    source_zh: "《道德经》第二十四章"
    interpretation: Every form of self-promotion is self-defeating. Displaying virtue reveals its deficiency; asserting wisdom reveals its incompleteness. The Taoist ideal is effortless presence — you shine because you are luminous, not because you show yourself.
    interpretation_zh: 每一种自我推销的形式都是自我挫败的。展示德行暴露其不足；声称智慧揭示其不完整。道家理想是毫不费力的在场——你发光是因为你本就是发光的，而非因为你展示自己。
---
