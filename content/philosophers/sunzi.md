---
slug: sunzi
journey_slug: ch03-sunzi
biography_zh: |
  孙子，即孙武，春秋末期齐国人，后入吴国为将。据《史记》记载，孙武以兵法十三篇献吴王阖闾，吴王令其以宫女试阵，孙武严明军纪，斩杀吴王两名宠姬以立威，最终使宫女令行禁止。吴王遂拜其为将，与伍子胥共助吴国西破强楚、北威齐晋，使吴国一时称霸。孙武晚年隐居不知去向，但其所著《孙子兵法》十三篇——从"计篇"到"用间篇"——系统论述了战争的战略原则、战术运用与情报体系，被誉为"兵学圣典"。全书仅六千余字，却涵盖了现代军事科学的几乎所有核心命题，其影响远超军事领域，深刻渗透于商业战略、博弈论与组织管理之中。
modern_influence: |
...
modern_influence_zh: |
  ...
  《孙子兵法》是全球企业董事会议室中影响力最大的军事文本。其原则——了解竞争环境，攻敌不备，尽可能不战而胜——被从麦肯锡顾问到硅谷创始人的各类战略家所采纳。地形分析章节变为市场细分；间谍章节变为竞争情报；通过定位而非对抗取胜的原则变为品牌战略。

  ## 孙子与博弈论

  孙子对信息不对称、战略欺骗与计算风险的强调，比现代博弈论早了两千余年。他的"五事"（道、天、地、将、法）胜利归属论是一个全面的不确定性战略决策模型——本质上是经济学家所称决策理论的前现代版本。

  ## 孙子在体育与谈判中的应用

  职业运动队、扑克选手与外交谈判者都在运用孙子原则。研究对手模式并攻击其弱点的教练策略是纯粹的孙子兵法。创造条件使对方最佳选择是达成协议的谈判者，正在实践孙子"不战而屈人之兵"的最高原则。
core_concepts:
...
quotes:
  - text: "Know yourself and know your enemy, and you will never be defeated. If you know yourself but not your enemy, you will win half and lose half. If you know neither yourself nor your enemy, you will be defeated in every battle."
    ...
    source_zh: "《孙子兵法·谋攻篇》"
    interpretation: This is Sunzi's most famous maxim and his most essential principle. Information is the master resource. Complete knowledge yields complete confidence; partial knowledge yields partial results; ignorance yields certain failure.
    interpretation_zh: 这是孙子最著名的格言与最根本的原则。信息是主宰资源。完全的知识带来完全的信心；部分的知识带来部分的结果；无知带来确定的失败。
  - text: "The supreme art of war is to subdue the enemy without fighting."
    text_zh: "不战而屈人之兵，善之善者也。"
    source: "The Art of War, Chapter 3"
    source_zh: "《孙子兵法·谋攻篇》"
    interpretation: Sunzi's highest strategic ideal. A victory achieved through superior positioning, diplomatic leverage, or psychological dominance is better than any battlefield win, because it costs nothing and leaves no scars. The greatest commander is the one whose victory is invisible.
    interpretation_zh: 孙子最高的战略理想。通过优越定位、外交杠杆或心理优势达成的胜利优于任何战场胜利，因为它不耗成本、不留伤痕。最伟大的指挥官是胜利不可见的那个。
  - text: "All warfare is based on deception. When capable, appear incapable. When active, appear inactive. When near, appear far. When far, appear near."
  ...
  - text: "Water shapes its course according to the nature of the ground over which it flows; the soldier shapes his victory according to the enemy he faces."
    ...
    source: "The Art of War, Chapter 6"
    source_zh: "《孙子兵法·虚实篇》"
    interpretation: The analogy to water connects Sunzi to the Daoist tradition of adapting to circumstances rather than imposing fixed plans. There is no one correct strategy — only the strategy that fits the particular terrain, opponent, and moment. Wisdom is responsiveness, not rigidity.
    interpretation_zh: 与水的类比将孙子联系到道家顺应而非强加定计的传统。没有唯一正确的战略——只有适合特定地形、对手与时刻的战略。智慧是回应而非僵化。
  - text: "Speed is the essence of war. In a prolonged campaign, the army will be exhausted and the treasury drained."
    text_zh: "兵贵胜，不贵久。久则钝兵挫锐，攻城则力屈，久暴师则国用不足。"
    source: "The Art of War, Chapter 2"
    source_zh: "《孙子兵法·作战篇》"
    interpretation: Sunzi warns that time is the enemy of the aggressor. Every day of campaign increases costs, depletes resources, and risks unexpected complications. The strategist who wins quickly and economically wins best. Protracted effort, no matter how heroic, is strategic failure.
    interpretation_zh: 孙子警告时间是进攻者的敌人。战役的每一天增加成本、耗竭资源、冒意外复杂化的风险。快速而经济的取胜者胜得最好。旷日持久的努力，无论多么英勇，都是战略失败。
  - text: "Appear at points which the enemy must hasten to defend; march swiftly to places where you are not expected."
    text_zh: "攻其所必救，行其所不意。"
    source: "The Art of War, Chapter 6"
    source_zh: "《孙子兵法·虚实篇》"
    interpretation: The principle of strategic surprise applied through positioning rather than speed. You do not need to be faster than your opponent — you need to be where they cannot afford not to respond, and then move to the place they left unprotected. This is strategy as geometry, not brute force.
    interpretation_zh: 通过定位而非速度应用的战略突袭原则。你不需要比对手更快——你需要出现在他们不得不防守的地方，然后移动到他们因此放弃保护的地点。这是作为几何而非蛮力的战略。
  - text: "If you know the enemy and know yourself, you need not fear the result of a hundred battles. If you know yourself but not the enemy, for every victory gained you will also suffer a defeat."
    text_zh: "知己知彼，百战不殆。不知彼而知己，一胜一负。"
    source: "The Art of War, Chapter 3"
    source_zh: "《孙子兵法·谋攻篇》"
    interpretation: The gradient of knowledge creates a gradient of outcomes. Complete intelligence yields reliable success; partial intelligence yields unreliable outcomes; zero intelligence yields certain failure. Sunzi makes information the master variable of strategic life.
    interpretation_zh: 知识的梯度创造结果的梯度。完全情报带来可靠成功；部分情报带来不可靠结果；零情报带来确定失败。孙子使信息成为战略生活的主变量。
