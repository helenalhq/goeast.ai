...
modern_influence_zh: |
  ...
  周公所创立的礼乐制度为此后所有中国社会秩序提供了范式。从婚礼的仪式程序到宴席的座次排列，从商务谈判中以礼相待的步骤到日常社交中长幼有序的规矩，无不溯源于周公对"文明需要形式"这一原则的坚持。他的洞见在于：没有结构的人际互动终将堕入混乱，礼制为关系提供了容器。

  ## 《周易》与现代决策思维

  周公协助文王将八卦推演为六十四卦的系统，使《周易》成为全球性的战略思维工具。硅谷高管在产品发布前参考卦象，管理理论家引用其强调变化模式的洞见，荣格将其视为共时性的原型。六十四卦体系——以六爻编码六十四种转化状态——至今仍是人类所创造的最精简的动态系统模型之一。

  ## 跨文化的梦境解读传统

  周公与解梦的关联催生了《周公解梦》，这部梦境符号辞典至今仍在中国被引用。这一传统比弗洛伊德早了三千年，将梦境视为无意识关于未来的语言而非过去的回声。现代心理学对梦工作的关注，部分得益于这一古老前提：梦不是随机噪音，而是有意义的沟通。
core_concepts:
  - name: Ritual Order (Li)
    name_zh: 礼制
    description: Zhou Gong established that civilization requires structured social forms. Ritual (*li*) is not mere ceremony — it is the grammar of human relationships, giving shape to respect, obligation, and belonging. Without ritual, society is a body without bones.
    description_zh: 周公确立了文明需要结构化的社会形式这一原则。礼不仅是仪式，更是人际关系的语法，赋予尊重、义务与归属以形状。没有礼，社会便如无骨之躯。
  - name: Heavenly Mandate (Tianming)
    name_zh: 天命
    description: Zhou Gong articulated the doctrine that political authority derives from heaven's will, contingent on the ruler's virtue. A ruler who loses virtue loses the mandate. This was the first systematic theory of accountable governance in human history.
    description_zh: 周公阐明了政治权威源自天命、以统治者德行为条件的思想。失德则失命。这是人类历史上第一个系统性的权力问责理论。
  ...
  - name: Music as Moral Education (Yue)
    ...
    description_zh: 周公将礼与乐并置，认为和谐的音声滋养和谐的灵魂。乐不是消遣，而是公民基础设施——它塑造一个民族的情感地貌，使个人之心与社会秩序相合。
quotes:
  - text: "When the ruler is virtuous, the people follow; when the ruler loses virtue, heaven withdraws its mandate."
    text_zh: "为政以德，德失则天命移。"
    source: "Book of Documents (Shujing)"
    source_zh: "《尚书》"
    interpretation: This is the foundational statement of the Mandate of Heaven doctrine — authority is conditional, not absolute. It introduced the revolutionary idea that rulers serve at heaven's pleasure and must earn their position through moral conduct.
    interpretation_zh: 这是天命思想的基础陈述——权力是有条件的，而非绝对的。它引入了革命性的观念：统治者承天意而行，必须以德行赢得其位。
  - text: "Rites are the framework of the state; music is the harmony of its people."
    text_zh: "礼者，国之干也；乐者，民之和也。"
    source: "Record of Rites (Liji)"
    source_zh: "《礼记》"
    interpretation: Zhou Gong understood that law alone cannot sustain a civilization. Ritual gives social interaction its structure; music gives it its feeling. Together, they create a society that is both ordered and alive.
    interpretation_zh: 周公明白仅靠法律无法维系文明。礼赋予社会互动以结构，乐赋予其情感。二者合之，方能创造既有序又有活力的社会。
  - text: "The superior man examines himself three times a day."
    text_zh: "吾日三省吾身。"
    source: "Analects, attributed to Zhou Gong's tradition"
    source_zh: "《论语》，源于周公传统"
    interpretation: Self-reflection as daily practice became the core discipline of Confucian cultivation. The idea that moral growth requires constant self-examination traces directly to Zhou Gong's emphasis on virtue as the basis of all authority.
    interpretation_zh: 日自省作为日常实践，成为儒家修养的核心功夫。道德成长需要恒常自省的观念，直接追溯至周公对德行作为一切权力根基的强调。
  - text: "Heaven sees as the people see; heaven hears as the people hear."
    text_zh: "天视自我民视，天听自我民听。"
    source: "Book of Documents (Shujing)"
    source_zh: "《尚书》"
    interpretation: This remarkable statement links divine will to popular sentiment — heaven's mandate is not inscrutable but expressed through the people's satisfaction or discontent. It is an ancient precursor to democratic accountability.
    interpretation_zh: 这一卓越的陈述将天意与民心相连——天命并非不可揣度，而是通过百姓的满意或不满来表达。它是民主问责的古老先驱。
  - text: "In change there is the great ultimate; from the great ultimate emerge the two forces."
    text_zh: "易有太极，是生两仪。"
    source: "I Ching, Great Commentary (Xici)"
    source_zh: "《周易·系辞》"
    interpretation: This cosmological statement describes the origin of reality as a dynamic process — from unity emerges duality (yin and yang), and from duality emerges multiplicity. It is one of the earliest systematic models of cosmogenesis.
    interpretation_zh: 这一宇宙论陈述描述了现实的本源是一个动态过程——从统一生出二元（阴与阳），从二元生出万物。这是最早的系统性宇宙生成模型之一。
  - text: "The way of heaven reduces the excessive and augments the deficient; the way of man reduces the deficient and augments the excessive."
    text_zh: "天道损有余而补不足，人道损不足以奉有余。"
    source: "I Ching, Great Commentary (Xici)"
    source_zh: "《周易·系辞》"
    interpretation: A critique of human inequality written millennia before Piketty. Heaven naturally redistributes toward balance; human societies tend toward concentration. Moral governance means aligning human systems with heaven's tendency toward equilibrium.
    interpretation_zh: 这是对人类不平等的批判，写于皮凯蒂之前数千年。天道自然趋向平衡再分配；人类社会则倾向于集中。道德治理意味着使人类系统与天道趋向均衡的倾向相合。
  - text: "When the wind blows over the earth, all things respond; when the ruler acts with virtue, all people follow."
