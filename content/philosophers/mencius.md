---
slug: mencius
journey_slug: ch05-mencius
biography_zh: |
  孟子，名轲，战国邹国人，约生于公元前372年，卒于公元前289年。他是孔子之后儒家最重要的思想家，被后世尊为"亚圣"。孟子幼年丧父，母亲为教育他而三次迁居——从墓地旁迁至市集旁，再迁至学宫旁——终使孟子在良好的环境中成长，此即著名的"孟母三迁"。孟子受业于孔子之孙子思的门人，继承了儒家的仁学传统并加以发展。他曾游历齐、梁、宋、鲁等国，向君主推行"仁政"与"王道"，主张"民为贵，社稷次之，君为轻"，但终未见用。晚年归邹著书讲学，留下《孟子》七篇，以性善论、仁政思想与浩然之气闻名于世，深刻塑造了儒家人文主义传统与东亚政治伦理。
modern_influence: |
...
modern_influence_zh: |
  ...
  孟子"民为贵、失德失命"的学说被现代学者重新收回为中国人民主问责的内生基础。不同于以个人自主为起点的人权理论，孟子将人的尊严奠基于关系义务——联结统治者与臣民、父母与子女、朋友与朋友的互惠关怀。这一关系模型为普遍人权提供了不依赖西方自由传统的补充性根基。

  ## 孟子与发展心理学

  孟子的性善论——先天道德萌芽——预示了发展心理学的新发现。保罗·布鲁姆等人的研究表明婴儿在尚未社会化之前就表现出初步道德行为——偏好帮助者、对伤害感到不安。孟子论证同情、羞耻、恭敬与是非之心是先天萌芽需要培育；现代科学正在确认道德的原材料确实从出生便存在。

  ## 孟子与环境伦理

  孟子坚持统治者必须保护自然环境——他警告不可滥伐滥捕——使他成为生态治理的早期声音。他论证破坏环境便是破坏人民生计，将人类福祉与生态健康联系起来，现代可持续发展框架呼应了这一点。"不违农时，谷不可胜食也。"
core_concepts:
...
quotes:
  - text: "The people are the most important element in a state; the altars of the soil and grain are next; the sovereign is the least."
    ...
    source_zh: "《孟子·尽心下》"
    interpretation: Mencius ranks the people above both the territorial state and the sovereign — a principle that anticipates democratic accountability by two millennia. The ruler's legitimacy derives entirely from the people's welfare; when the people suffer, the ruler has no moral standing to govern.
    interpretation_zh: 孟子将人民置于领土国家与君主之上——一项预示民主问责两千年的原则。统治者的合法性完全源于人民福祉；当人民受苦时，统治者没有治理的道德立场。
  - text: "No man is devoid of a heart sensitive to the suffering of others. Suppose a man suddenly sees a child about to fall into a well — he will certainly feel alarm and distress. This is not because he wants friendship with the child's parents, nor because he seeks praise from neighbors and friends, nor because he dislikes the reputation of being callous."
    text_zh: "人皆有所不忍。今人乍见孺子将入于井，皆有怵惕恻隐之心。非所以内交于孺子之父母也，非所以要誉于乡党朋友也，非恶其声而然也。"
    source: "Mencius, 2A.6"
    source_zh: "《孟子·公孙丑上》"
    ...
    interpretation_zh: 孟子最著名的性善论证。对孩子危险的自发焦虑不是计算的、不是社会的、不是利己的——它是任何推理介入之前道德萌芽中同情的纯粹运作。这是从日常经验中得出的经验证明：善是自然的。
  - text: "When the people have constant livelihood, they will have constant hearts. When they lack constant livelihood, they will lack constant hearts. Without constant hearts, they will become depraved and wicked."
    text_zh: "民之为道也，有恒产者有恒心，无恒产者无恒心。苟无恒心，放僻邪侈，无不为已。"
    source: "Mencius, 3A.3"
    source_zh: "《孟子·滕文公上》"
    interpretation: Mencius recognizes that moral stability requires economic stability. You cannot demand virtue from people who are starving; you must first provide the material conditions in which virtue can flourish. This is a profoundly humane economics that links welfare policy directly to moral development.
    interpretation_zh: 孟子认识到道德稳定需要经济稳定。你不能对挨饿的人要求德行；你必须首先提供德行得以繁盛的物质条件。这是一种深刻的人性经济学，将福利政策直接关联于道德发展。
  - text: "He who uses virtue to practice benevolence will become a true king. He who uses force to simulate benevolence will become a nominal king. The former gains the hearts of the people; the latter gains only their obedience."
    text_zh: "以德行仁者王，以力假仁者霸。以德行仁者，民心也；以力假仁者，民力也。"
    source: "Mencius, 2A.3"
    source_zh: "《孟子·公孙丑上》"
    ...
    interpretation_zh: 孟子区分真正的仁（赢得人心）与假仁（仅赢得身体服从）。真正的王者以人民甘愿追随的道德权威治理；霸者以人民不甘愿服从的武力治理。差别在于真正的合法性与被胁迫的服从。
  - text: "If the ruler makes serious mistakes, they should be remonstrated. If repeated remonstrance is ignored, the ruler should be removed."
    text_zh: "君有大过则谏，反复之而不听，则易位。"
    source: "Mencius, 5B.9"
    source_zh: "《孟子·万章下》"
    ...
    interpretation_zh: 孟子明确主张拒绝纠正重大道德错误的统治者应被撤换。这不仅是对批评——这是将人民福祉置于统治者任期之上的问责治理宪政原则。它预示弹劾概念两千年。
  - text: "Firm in his will, resolute in his conduct, he does not exchange his principles even for the whole world."
  ...
  - text: "The vast, resolute qi is produced by accumulated righteousness and cannot be obtained by sporadic acts. It fills the space between heaven and earth."
    ...
    interpretation_zh: 孟子描述了一种通过持续正义实践积累、因不连贯而消散的道德能量。它不是一次英雄行为的结果而是持续道德努力的产物——一种使践行者不可动摇的身心力量。这一概念预示了现代对道德韧性与心理耐力的理解。
---
