---
slug: confucius
journey_slug: ch02-confucius
biography_zh: |
  孔子，名丘，字仲尼，春秋鲁国曲阜人，生于公元前551年，卒于公元前479年。他是儒家学派的创始人，被后世尊为"至圣先师"。孔子少时家贫，但好学不倦，曾为鲁国司寇，后因政见不合而周游列国十四年，寻求能够推行仁政的君主，终未如愿。晚年归鲁，潜心教育，有弟子三千，贤人七十二。他删订《诗》《书》《礼》《乐》，作《春秋》，对中国文化的保存与传播贡献卓著。其言行由弟子辑为《论语》，以"仁"与"礼"为核心，构建了以修身齐家治国平天下为路径的伦理体系，影响中国社会两千余年，至今仍是东亚文明的道德根基。
modern_influence: |
...
modern_influence_zh: |
  ...
  孔子对等级、互惠义务与长期关系的强调，至今仍可见于东亚商业文化。韩国财阀、日本经连体系与中国家族企业都运行于儒家假设之上：忠诚向上流动，庇护向下传递，关系以数十年而非季度为单位建立。西方分析者常误读此为腐败；事实上，这是经济生活中的仁与礼。

  ## 儒家教育与现代教学法

  孔子堪称世界上第一位职业教师，其教学原则——因材施教、德育与智育并重、终身学习——仍是东亚学校教育的基础。尊师重道、先记诵而后理解、以道德品格为教育目标，皆追溯至他的学堂。

  ## 儒家与人权话语

  孔子"民为邦本"、"失德则失命"的学说被现代学者重新阐释为问责治理的内生源泉。约瑟夫·陈与杜维明等学者论证：仁与互惠的儒家价值可以为人权提供基于关系伦理而非个人自主的基础，为普遍尊严提供替代性的根基。
core_concepts:
  - name: Ren (Humaneness)
    name_zh: 仁
...
quotes:
  ...
  - text: "Do not impose on others what you yourself do not desire."
    text_zh: "己所不欲，勿施于人。"
    source: "Analects, 12.2 and 15.24"
    source_zh: "《论语·颜渊》《论语·卫灵公》"
    interpretation: This is the Confucian golden rule — the negative formulation that is more cautious and more powerful than its positive counterpart. Rather than assuming you know what others want, it asks only that you refrain from doing what you yourself find harmful. It is a principle of restraint, not presumption.
    interpretation_zh: 这是儒家金律——否定式表述比肯定式更谨慎也更有力。不假设你知道他人想要什么，只要求你不做自己觉得有害的事。这是克制原则，而非自以为是的原则。
  - text: "At fifteen, I set my heart on learning. At thirty, I stood firm. At forty, I had no doubts. At fifty, I knew the mandate of heaven. At sixty, my ear was attuned. At seventy, I could follow my heart's desire without transgressing what was right."
    text_zh: "吾十有五而志于学，三十而立，四十而不惑，五十而知天命，六十而耳顺，七十而从心所欲，不逾矩。"
    source: "Analects, 2.4"
    source_zh: "《论语·为政》"
    ...
    interpretation_zh: 孔子将一生自传压缩为六个阶段——不是成就而是内在自由的状态。轨迹从立志经安立、明辨与宇宙认知，终结于完全道德契合中的完全自发性悖论。终极自由不是脱离道德的自由，而是在道德之内的自由。
  - text: "The superior man is universal in his outlook, not partisan; the inferior man is partisan, not universal."
    text_zh: "君子周而不比，小人比而不周。"
    source: "Analects, 2.14"
    source_zh: "《论语·为政》"
    interpretation: The junzi takes the whole picture into account, weighing multiple perspectives before acting; the petty person aligns with factional interests. Partisanship is not merely a political vice — it is a failure of moral imagination, the inability to see beyond one's own group.
    interpretation_zh: 君子从全局出发，权衡多方视角而后行动；小人则以派系利益为取向。党派性不仅是政治恶行——更是道德想象力的失败，无法超越自身群体看问题。
  - text: "By nature, people are alike; by practice, they grow far apart."
    text_zh: "性相近也，习相远也。"
    source: "Analects, 17.2"
    source_zh: "《论语·阳货》"
    interpretation: Confucius affirms a common human nature but insists that what differentiates people is habit and cultivation. This is the philosophical foundation for education — if character is formed by practice, then practice can be guided, and moral development becomes a teachable skill rather than an inherited fate.
    interpretation_zh: 孔子肯定人性的相近，但坚持区分人的是习惯与修养。这是教育的哲学基础——如果品格由实践塑造，那么实践可以被引导，道德发展便成为可教之技而非继承之命。
  ...
  - text: "When you see a worthy person, think of equaling them; when you see an unworthy person, reflect on your own character."
    ...
    source_zh: "《论语·里仁》"
    interpretation: Every encounter becomes material for self-improvement. The worthy person shows what is possible; the unworthy person reveals what to guard against in yourself. Confucius transforms the entire social world into a mirror for moral development.
    interpretation_zh: 每一次相遇都成为自我改善的材料。贤者展示可能性；不贤者揭示你自身需要警惕之处。孔子将整个社会世界转化为道德发展的镜子。
  - text: "The people are the most important element in a state; the spirits of the land and grain are next; the sovereign is the least."
    text_zh: "民为贵，社稷次之，君为轻。"
    source: "Mencius, drawing on Confucian tradition"
    source_zh: "《孟子》，源自儒家传统"
    ...
    interpretation_zh: 这一排序——人民高于统治者——是古代政治思想中最激进的陈述之一。它将普通百姓的福祉置于领土国家与君主之上，确立了优先人民利益的前民主治理原则。
---
